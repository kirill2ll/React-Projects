...
export default function Tasks({ project, handleAddTaskToProject, handleDeleteTaskfromProject }) {
    return <section>
        ...
        {project.tasks.length === 0 && <p className="text-stone-800 my-4">This project doesn't have any tasks.</p>}

        {project.tasks.length > 0 && <ul className="p-4 mt-8 rounded-md bg-stone-100">
